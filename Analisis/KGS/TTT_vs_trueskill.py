...
df= pd.read_csv('./Trueskill_datos_sin_handicap.csv')
df_h = pd.read_csv('./Trueskill_datos_con_handicap.csv')
df_TTT = pd.read_csv('./TTT_datos_sin_handicap.csv')
df_TTT_h= pd.read_csv('./TTT_datos_con_handicap.csv')
...
print("Evidencia de TrueSkill sin handicap: ", evidencia)
print("Evidencia de TrueSkill con handicap: ", evidencia_h)
print("Evidencia de TTT sin handicap: ", evidencia_TTT)
print("Evidencia de TTT con handicap: ", evidencia_TTT_h)
