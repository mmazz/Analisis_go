...
using Dates
using DataFrames
data = DataFrame!(CSV.File("./sim_3Jugadores_muchaDiff.csv"))
#data = data[1:300000,:]
...
CSV.write("./sim_3Jugadores_muchaDiff_TS_julia.csv", df; header=true)
...
println(evidence)
#CSV.write("TTT_datos.csv", df; header=true)
CSV.write("./sim_3Jugadores_muchaDiff_TTT_julia.csv", df; header=true)
