...
plt.plot("Sigma", "Evidencia_ts", data=df_ev,c='firebrick', linestyle=':',linewidth=3, label="TrueSkill")
plt.plot("Sigma", "Evidencia_ttt", data=df_ev,c='steelblue',linewidth=3, label="TTT")
plt.scatter(mints, df_ev['Evidencia_ts'].min(), data=df_ev,c='orange',linewidth=2)
plt.scatter(minttt, df_ev['Evidencia_ttt'].min(), data=df_ev,c='cyan',linewidth=2)
plt.axvline(1.2,c='black',linestyle='--',linewidth=1)
...
plt.figure(4)
#df_mu.plot()
plt.plot("ts_0001", data=df,c='red', marker='*',markersize=4, linewidth=1, label="TrueSkill $\sigma_0$=0.0001")
plt.plot("ttt_0001", data=df,c='b',linewidth=2, label="TTT $\sigma_0$=0.0001")
plt.plot("ts_3", data=df,c='green', marker='*',linewidth=3, label="TrueSkill $\sigma_0$=3")
plt.plot("ttt_3", data=df,c='steelblue',linewidth=2, label="TTT $\sigma_0$=3")
plt.plot("ts_10", data=df,c='orange',linewidth=2, marker='*', label="TrueSkill $\sigma_0$=10")
...
plt.figure(5)
#df_mu.plot()
plt.plot("ts_0001", data=df_mu,c='red', marker='*',markersize=4, linewidth=1, label="TrueSkill $\sigma_0$=0.0001")
plt.plot("ttt_0001", data=df_mu,c='b',linewidth=2, label="TTT $\sigma_0$=0.0001")
plt.plot("ts_3", data=df_mu,c='green', marker='*',linewidth=3, label="TrueSkill $\sigma_0$=3")
plt.plot("ttt_3", data=df_mu,c='steelblue',linewidth=2, label="TTT $\sigma_0$=3")
plt.plot("ts_10", data=df_mu,c='orange', marker='*',linewidth=2, label="TrueSkill $\sigma_0$=10")
...
plt.plot("ts_1", data=df_mu,c='orange', marker='*',linewidth=3, label="TrueSkill \u03B2$_0$=1")
plt.plot("ttt_1", data=df_mu,c='green',linewidth=2, label="TTT \u03B2$_0$=1")
plt.plot("ts_5", data=df_mu,c='cyan', marker='*',linewidth=2, label="TrueSkill \u03B2$_0$=5")
plt.plot("ttt_5", data=df_mu,c='purple',linewidth=2, label="TTT \u03B2$_0$=5")
plt.plot("ts_10", data=df_mu,c='firebrick', marker='*',linewidth=2, label="TrueSkill \u03B2$_0$=10")
plt.plot("ttt_10", data=df_mu,c='steelblue',linewidth=2, label="TTT \u03B2$_0$=10")
