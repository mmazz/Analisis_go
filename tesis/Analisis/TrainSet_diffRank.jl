...
using Dates
using DataFrames
data = CSV.read("../img/Datos/TrainSet_diffRank.csv")
...
CSV.write("../img/Datos/TrainingSet_diffRank_TTT.csv", df; header=true)
df = DataFrame(evidencias_ts = evidencias_ts
                ,evidencias_ttt = evidencias_ttt)
CSV.write("../img/Datos/TrainingSet_diffRank_evidence.csv", df; header=true)
